...
_assign_function("R_tryCatch", SEXP, [CFUNCTYPE(SEXP, c_void_p), c_void_p, SEXP, CFUNCTYPE(SEXP, SEXP, c_void_p), c_void_p, CFUNCTYPE(None, c_void_p), c_void_p])
_assign_function("R_tryCatchError", SEXP, [CFUNCTYPE(SEXP, c_void_p), c_void_p, CFUNCTYPE(SEXP, SEXP, c_void_p), c_void_p])
